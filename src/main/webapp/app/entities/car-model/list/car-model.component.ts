...
export class CarModelComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.carModelService
      ...
      .subscribe({
        next: (res: HttpResponse<ICarModel[]>) => {
  ...
  trackId(_index: number, item: ICarModel): number {
    return item.id!;
  }

  delete(carModel: ICarModel): void {
    const modalRef = this.modalService.open(CarModelDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ICarModel[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
