...
describe('CarModel Management Component', () => {
  let comp: CarModelComponent;
  let fixture: ComponentFixture<CarModelComponent>;
  let service: CarModelService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'car-model', component: CarModelComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CarModelComponent, '')
      .compileComponents();
