...
describe('VehicleListing Management Component', () => {
  let comp: VehicleListingComponent;
  let fixture: ComponentFixture<VehicleListingComponent>;
  let service: VehicleListingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'vehicle-listing', component: VehicleListingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(VehicleListingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicleListings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
