...
import ca.verticalidigital.carplace.service.MailService;
...
public class UserResource {
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return ResponseUtil.wrapOrNotFound(userService.getUserWithAuthoritiesAndDealerByLogin(login).map(AdminUserDTO::new));
    }
